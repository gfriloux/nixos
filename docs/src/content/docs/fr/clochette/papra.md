---
title: Papra
description: Gestionnaire de documents — configuration, health check, secrets, middlewares Traefik.
---

Gestionnaire de documents auto-hébergé exposé à <https://docs.friloux.me>.
