# Réinstallation — clochette

Guide de réinstallation complète du serveur clochette (VPS Scaleway).

> ⚠️ **Avant de commencer** : garder un shell root ouvert pendant toute l'opération.
...
> ⚠️ **Destructif.** Toutes les données sur `/dev/sda` sont perdues.
